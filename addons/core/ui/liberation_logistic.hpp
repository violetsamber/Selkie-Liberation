class liberation_logistic {
    ...
    class InnerBG1: OuterBG1 {
        ...
        w = QUOTE((0.12 * safezoneW) + (2 * BORDERSIZE));
    ...
    class InnerBG2: OuterBG1 {
        colorBackground[] = COLOR_GREEN;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (BORDERSIZE));
        y = QUOTE((0.2 * safezoneH + safezoneY) - (1.5 * BORDERSIZE));
        w = QUOTE((0.153 * safezoneW) + (2 * BORDERSIZE));
        h = QUOTE((0.55 * safezoneH) + (3 * BORDERSIZE));
    };
    ...
    class InnerBG3: OuterBG1 {
        colorBackground[] = COLOR_GREEN;
        x = QUOTE((0.51 * safezoneW + safezoneX) - (BORDERSIZE));
        y = QUOTE((0.2 * safezoneH + safezoneY) - (1.5 * BORDERSIZE));
        w = QUOTE((0.29 * safezoneW) + (2 * BORDERSIZE));
        h = QUOTE((0.55 * safezoneH) + (3 * BORDERSIZE));
    };
    ...
    class LogisticList: StdListBox {
        ...
        y = QUOTE((0.2 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.12 * safezoneW) + BORDERSIZE);
        h = QUOTE((0.50 * safezoneH) + (1.5 * BORDERSIZE));
        shadow = 2;
        onLBSelChanged="";
    };
    ...
    class StatusLabel: StdText {
        idc = 75806;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.23 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
    ...
    class Status: StatusLabel {
        idc = 75807;
        style = ST_RIGHT;
        x = QUOTE((0.4145 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
    ...
    class TimeLabel: StdText {
        idc = 75808;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.26 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.07 * safezoneW));
        h = QUOTE((0.02 * safezoneH));
    ...
    class DestinationLabel: StdText {
        idc = 758010;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.29 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.07 * safezoneW));
        h = QUOTE((0.02 * safezoneH));
    ...
    class LoadedTitle: StdText {
        ...
        colorBackground[] = COLOR_BLACK_ALPHA;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.34 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.153 * safezoneW) + BORDERSIZE);
        h = QUOTE((0.02 * safezoneH));
    ...
    class TruckCountLabel: StdText {
        idc = 758013;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.37 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.07 * safezoneW));
        h = QUOTE((0.02 * safezoneH));
    ...
    class LoadedSupplyLabel: StdText {
        idc = 758015;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.4 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.07 * safezoneW));
        h = QUOTE((0.02 * safezoneH));
    ...
    class LoadedAmmoLabel: StdText {
        idc = 758017;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.43 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.07 * safezoneW));
        h = QUOTE((0.02 * safezoneH));
        text = QUOTE($STR_AMMO);
    };
    ...
    class LoadedFuelLabel: StdText {
        idc = 758019;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.46 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.07 * safezoneW));
        h = QUOTE((0.02 * safezoneH));
        text = QUOTE($STR_FUEL);
    };
    ...
    class ButtonBuyTruck: StdButton {
         idc = 758021;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.49 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.0725 * safezoneW) + BORDERSIZE);
        h = QUOTE((0.02 * safezoneH));
    ...
    class ButtonSellTRuck: StdButton {
         idc = 758022;
        x = QUOTE((0.4185 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.49 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.0725 * safezoneW) + BORDERSIZE);
        h = QUOTE((0.02 * safezoneH));
    ...
    class ATitle: StdText {
        ...
        colorBackground[] = COLOR_BLACK_ALPHA;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.54 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.153 * safezoneW) + BORDERSIZE);
        h = QUOTE((0.02 * safezoneH));
    ...
    class ASupp: StdEdit {
        idc = 758025;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.6 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
    ...
    class AAmmo: StdEdit {
        idc = 758026;
        x = QUOTE((0.392 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.6 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE(0.05 * safezoneW);
        text = "";
    ...
    class AFuel: StdEdit {
        idc = 758027;
        x = QUOTE((0.446 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.6 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE(0.05 * safezoneW);
        text = "";
    ...
    class BTitle: StdText {
        ...
        colorBackground[] = COLOR_BLACK_ALPHA;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.63 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.153 * safezoneW) + BORDERSIZE);
        h = QUOTE((0.02 * safezoneH));
    ...
    class BSupp: StdEdit {
        idc = 758030;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.69 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE(0.05 * safezoneW);
        text = "";
        tooltip = QUOTE($STR_LOGISTIC_TT_SUPPLY);
        action = "";
    ...
    class LogisticMap: kndr_MapControl {
        idc = 758098;
        x = QUOTE((0.51 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.2 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.29 * safezoneW) + BORDERSIZE);
        h = QUOTE((0.55 * safezoneH) + (1.5 * BORDERSIZE));
    };
