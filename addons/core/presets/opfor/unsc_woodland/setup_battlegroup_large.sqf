...
//4-5 Pelican or Falcon Drops
private _paradrops = [100,100,100,100,50];
...
//3 Transport Vics
private _transports = [100,100,100,100];
...
//~1-2 Air vic
private _air = [100,100,50];
private _air_veh = [
    [SLK_UNSC_ARMY_FALCON_ARMED_WOODLAND,50],
