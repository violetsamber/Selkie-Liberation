...
GRLIB_sector_size = 500;                                                // Range to activate a sector. (This is normally 1000, but Mehland is very small so I brought it down, otherwise you're always activating at least 2 sectors.)
...
GRLIB_surrender_chance = 5;                                             // Chance that enemy infantry will surrender after heavy losses are encountered.
...
SLKLIB_combat_readiness_cap = 300;                                       // Cap for combat readiness
