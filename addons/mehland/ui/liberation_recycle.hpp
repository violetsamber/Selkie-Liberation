class liberation_recycle {
    ...
    class ManpowerImageShadow: IconImage {
        idc = 1085;
        x = QUOTE((0.42 * safezoneW + safezoneX)  + 0.003);
        text = "res\ui_manpo.paa";
        colorText[] = {0, 0, 0, 1};
        y = QUOTE((0.5 * safezoneH + safezoneY) + 0.005);
    };
    class AmmoImageShadow: IconImage {
        idc = 1085;
        x = QUOTE((0.48 * safezoneW + safezoneX) + 0.003);
        text = "res\ui_ammo.paa";
        colorText[] = {0, 0, 0, 1};
        y = QUOTE((0.5 * safezoneH + safezoneY) + 0.005);
    };
    class FuelImageShadow: IconImage {
        idc = 1085;
        x = QUOTE((0.54 * safezoneW + safezoneX)  + 0.003);
        text = "res\ui_fuel.paa";
        colorText[] = {0, 0, 0, 1};
        y = QUOTE((0.5 * safezoneH + safezoneY) + 0.005);
    };
    ...
    class LabelManpower: LabelNumber {
        idc = 131;
        x = QUOTE((0.44 * safezoneW + safezoneX) - BORDERSIZE);
        colorText[] = {0, 0.75, 0, 1};
    };
    class LabelAmmo: LabelNumber {
        idc = 132;
        x = QUOTE((0.5 * safezoneW + safezoneX) - BORDERSIZE);
        colorText[] = {0.75, 0, 0, 1};
    };
    class LabelFuel: LabelNumber {
        idc = 133;
        x = QUOTE((0.56 * safezoneW + safezoneX) - BORDERSIZE);
        colorText[] = {0.75, 0.75, 0, 1};
    };
    class RecycleButton: StdButton {
        idc = 120;
        x = QUOTE((0.4 * safezoneW + safezoneX) - (BORDERSIZE));
