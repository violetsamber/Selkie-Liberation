class liberation_production {
    ...
    class SectorTimerLabel: StdText {
        idc = -1;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.32 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.07 * safezoneW));
        h = QUOTE((0.02 * safezoneH));
    ...
    class StorageTitle: StdText {
        ...
        colorBackground[] = COLOR_BLACK_ALPHA;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.51 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.153 * safezoneW) + BORDERSIZE);
        h = QUOTE((0.02 * safezoneH));
    ...
    class ProduceTitle: StdText {
        ...
        colorBackground[] = COLOR_BLACK_ALPHA;
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.65 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.153 * safezoneW) + BORDERSIZE);
        h = QUOTE((0.02 * safezoneH));
    ...
    class ProduceToolBox {
        ...
        x = QUOTE((0.338 * safezoneW + safezoneX) - (0.5 * BORDERSIZE));
        y = QUOTE((0.68 * safezoneH + safezoneY) - (0.75 * BORDERSIZE));
        w = QUOTE((0.153 * safezoneW) + BORDERSIZE);
