...
GRLIB_sector_size = 750;                                                // Range to activate a sector. (This is normally 1000, but Madrigal is very small so I brought it down, otherwise you're always activating at least 2 sectors.)
